...
const filesToCopy = [{
  ...
  // },{
  source: 'src/api/controlers/business-logic/vpn-config-files/openvpn-hs-augsburg.ovpn',
  target: 'dist/server/controlers/business-logic/vpn-config-files/openvpn-hs-augsburg.ovpn'
}, {
  ...
  source: 'building/Prerequisites/npm-node-gyp-install.bat',
  target: 'dist/Prerequisites/npm-node-gyp-install.bat'
}, {
