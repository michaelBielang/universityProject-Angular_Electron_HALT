...
exports.createTableStatements = {
  ...
  history: 'CREATE TABLE history(pk_history_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_user_id INTEGER, searched_rz_nr INTEGER, name VARCHAR(255), e_mail VARCHAR(255), faculty VARCHAR(255), subject VARCHAR(255), gender INTEGER, FOREIGN KEY (fk_user_id) REFERENCES user(pk_user_id))',
